...
\AddToShipoutPictureFG{
  \AtPagemyUpperLeft{{\includegraphics[width=2.5cm,keepaspectratio]{logo}}}
}%
...
\begin{frame}{Thanks}
  \begin{itemize}
    \item These slide are a (small) variation of the presentation by \href{https://zenodo.org/record/3360480\#.Xyff9i2w0vo}{Hannah Short}
  \end{itemize}
\end{frame}
...
\begin{column}{0.5\textwidth}
  \begin{itemize}
    \item Member of the \href{https://advancedinstitute.ai}{Advanced Institute for Artificial Intelligence} 
    \item Member of the \href{https://sprace.org.br}{Sao Paulo Research and Analysis Center} 
    \item Experience with High Performance Computing and Artificial Intelligence
    \vspace{.4em}
    \item Very amateur Climber, Cyclist, Runner, Swimmer, etc; (-:
  \end{itemize}
\end{column}
...
\begin{column}{0.5\textwidth}  %%<--- here
  \begin{center}
  \begin{figure}
    \includegraphics[width=.7\linewidth]{me.png}
  \end{figure}
  \end{center}
\end{column}
\end{columns}
